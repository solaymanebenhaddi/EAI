...
export const beforeAfterVideos: ProjectVideo[] = [
  {
    ...
    location: 'Casablanca',
    url: '/assets/gallerie/video_2026-07-13_14-44-26 (17).mp4',
    provider: 'direct',
    aspectRatio: '9:16',
  ...
  },
  {
    ...
    category: 'Résidentiel',
    location: 'Rabat',
    url: '/assets/gallerie/video_2026-07-13_14-44-26 (3).mp4',
    provider: 'direct',
    aspectRatio: '9:16',
  ...
  },
  {
    ...
    location: 'Marrakech',
    url: '/assets/gallerie/video_2026-07-13_14-44-26 (10).mp4',
    provider: 'direct',
    aspectRatio: '9:16',
