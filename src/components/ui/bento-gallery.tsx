...
> = ({ imageItems, title, description }) => {
  ...
  return (
    <section
      ref={targetRef}
      id="portfolio"
      className="relative w-full overflow-hidden bg-eai-charcoal py-16 sm:py-24"
    >
      <motion.div
        style={{ opacity, y }}
        className="container mx-auto px-4 text-center"
      >
        <p className="text-xs tracking-[0.3em] uppercase opacity-40 mb-4 text-eai-paper">Portfolio</p>
        <h2 className="text-[clamp(2rem,4.5vw,3.6rem)] leading-[1.05] font-extrabold uppercase tracking-tight text-eai-paper font-sans">
          {title}
        </h2>
