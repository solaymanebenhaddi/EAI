  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <img
          src="/images/events/hero-eai-events.webp"
          alt="ELAOUAD Events - Forums, conférences et expositions professionnelles"
      ...
      >
        ...
        >
          ...
          <span className="block text-eai-brass">{t('heroTitle3')}</span>
        </motion.h1>
        ...
        >
          <a
            ...
            onClick={() => trackEvent('external_link', { destination: 'events_platform', location: 'hero' })}
          ...
          <Link
            href="/contact"
            onClick={() => trackEvent('cta_click', { location: 'events_hero', label: 'exhibitor' })}
