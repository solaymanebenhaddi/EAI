    ...
    <section ref={sectionRef} className="relative py-24 lg:py-32 overflow-hidden bg-eai-ink">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <span className="block">{t('finalTitle1')}</span>
            <span className="block text-eai-brass">{t('finalTitle2')}</span>
          </motion.h2>
          ...
          >
            <Link
              href="/contact"
              onClick={() => trackEvent('cta_click', { location: 'expertises_final', label: 'contact' })}
            ...
            <Link
              href="/projets"
              onClick={() => trackEvent('cta_click', { location: 'expertises_final', label: 'projects' })}
          ...
          >
            <div className="flex flex-col gap-2">
              <span className="text-[10px] text-eai-brass-pale/60">{t('finalEmail')}</span>
            ...
            <div className="flex flex-col gap-2">
              <span className="text-[10px] text-eai-brass-pale/60">{t('finalPhone')}</span>
              <a href="tel:+212520198738" className="hover:text-eai-brass transition-colors text-sm normal-case tracking-normal">
                +212 520 19 87 38
              </a>
            </div>
            <div className="flex flex-col gap-2">
              <span className="text-[10px] text-eai-brass-pale/60">{t('finalOffice')}</span>
              <span className="text-sm normal-case tracking-normal">{t('finalOfficeValue')}</span>
            </div>
          </motion.div>
        </div>
      </div>
